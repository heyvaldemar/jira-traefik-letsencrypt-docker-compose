...
- **`atlassian/jira-software:11.3.11` was rebuilt upstream**; the pin moved from `sha256:2de7e640cb9a…` to `sha256:6e4795fa808e…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
[Unreleased]: https://github.com/heyvaldemar/jira-traefik-letsencrypt-docker-compose/compare/v1.7.3...HEAD
...
[1.7.0]: https://github.com/heyvaldemar/jira-traefik-letsencrypt-docker-compose/compare/v1.6.0...v1.7.0
[1.6.0]: https://github.com/heyvaldemar/jira-traefik-letsencrypt-docker-compose/compare/v1.5.0...v1.6.0
[1.5.0]: https://github.com/heyvaldemar/jira-traefik-letsencrypt-docker-compose/compare/v1.4.0...v1.5.0
[1.4.0]: https://github.com/heyvaldemar/jira-traefik-letsencrypt-docker-compose/compare/v1.3.0...v1.4.0
